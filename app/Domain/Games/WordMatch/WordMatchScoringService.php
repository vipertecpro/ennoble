...
final class WordMatchScoringService implements GameScoringService
{
    /**
     * Calculate Word Match accuracy, response time, combo, and score from
     * authoritative round evidence. A correct answer earns a base, a speed
     * bonus, and a combo bonus; wrong answers and time-outs earn nothing.
     *
    ...
    private function speedBonus(?int $responseMs): int
    {
        ...
        return max(0, 100 - intdiv($responseMs, 40));
    }
}
